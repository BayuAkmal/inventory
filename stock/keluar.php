...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($jumlah >= $qtyskrg){
            ...
            $updatedata = mysqli_query($conn,"update sbrg_keluar set tgl='$tanggal', jumlah='$jumlah', satuan='$satuan', penerima='$penerima', keterangan='$keterangan' where id='$id'");
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="active">
                                    ...
                                    <li class="active"><a href="keluar.php">Barang Keluar / Pinjam</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Barang Keluar / Pinjam</span></li>
                            </ul>
                        </div>
                    </div>
											...
											while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="number" id="jumlah" name="jumlah" class="form-control" value="<?php echo $b['jumlah'] ?>"disabled>

                                                            <label for="penerima">Satuan</label>
                                                            <input type="text" id="satuan" name="satuan" class="form-control" value="<?php echo $b['satuan'] ?>">
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Input Barang Keluar / Pinjam</h4>
						</div>
						<div class="modal-body">
							<form action="barang_keluar_act.php" method="post">
								...
								<div class="form-group">
									...
									?>
										<option value="<?php echo $d['idx'] ?>"><?php echo $d['nama'] ?> --- Stock : <?php echo $d['stock'] ?> <?php echo $d['satuan'] ?></option>
										<?php
								}
								?>		
									</select>
