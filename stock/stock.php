...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_brg set nama='$nama', satuan='$satuan', lokasi='$lokasi' where idx='$idx'");
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="number" id="stock" name="stock" class="form-control" value="<?php echo $p['stock'] ?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus barang ini dari daftar aset?
                                                            <input type="hidden" name="idbrg" value="<?=$idb;?>">
                                                            </div>
