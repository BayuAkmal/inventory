...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update skas set nama='$nama', jumlah='$jumlah' where idy='$idy'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= kas.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from skas where idy='$idy'");
        //hapus juga semua data kas ini di tabel keluar-masuk
        $deltabelkeluar = mysqli_query($conn,"delete from skas_keluar where id='$idy'");
        $deltabelmasuk = mysqli_query($conn,"delete from skas_masuk where id='$idy'");
    ...
    <div class="page-container">
        ...
        <div class="main-content">
			...
			<?php 
				...
				$periksa_uang=mysqli_query($conn,"select * from skas where jumlah <0");
				while($p=mysqli_fetch_array($periksa_uang)){	
					if($p['jumlah']<=0){	
						?>	
						<script>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Daftar Keuangan</span></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$kass=mysqli_query($conn,"SELECT * from skas order by nama ASC");
											$no=1;
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit Kas <?php echo $p['nama']?></h4>
                                                            ...
                                                            <input type="hidden" name="idkas" value="<?=$idb;?>">
                                                        </div>
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Kas <?php echo $p['nama']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus kas ini dari daftar keuangan?
                                                            <input type="hidden" name="idkas" value="<?=$idb;?>">
                                                            </div>
									...
									<a href="exportkas.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_kas_act.php" method="post">
								<div class="form-group">
									<label>Nama</label>
									<input name="nama" type="text" class="form-control" placeholder="Nama Jenis Kas" required>
								</div>
								<div class="form-group">
								</div>
								<div class="form-group">
