...
<html>
<head>
<title>Transaksi Keuangan : Kas Keluar</title>
<link rel="icon" 
      type="image/png" 
      href="favicon.png">
...
<body>
		<div class="container">
			<h2>Transaksi Keuangan: Kas Keluar</h2>
			<h4>(My Kartar GMS 12)</h4>
				<div class="data-tables datatable-dark">
					<table class="display" id="dataTable3" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brg=mysqli_query($conn,"SELECT * from skas_keluar sb, skas st where sb.idy=st.idy order by sb.id ASC");
											$no=1;
